...
punct = '.,:;!?–—-\'\"()*/'
# ИСПРАВИТЬ: согласно условию, текст должен быть полностью очищен от знаков препинания
...
# КОММЕНТАРИЙ: не нужен вложенный цикл при полной очистке, сразу проходите по всем символам, фильтруя только подходящие
