...
# Введите любое целое число: 12
# И ещё разок: 2
# 12 делится на 2 нацело
# частное: 6

# Я внес изменения, но меня не покидает чувство что я сделал не совсем то что вы хотели)))
# В 43 строке вы написали не использовать блок else, это означало не использовать для stdout или буквально без него нужно было сделать? 
# --------------------------------------------------------------------------------------------
# num_1 = int(input('Введите любое целое число:')) 
# num_2 = int(input('И ещё разок:'))
